...
class Client:
    ...
    def __init__(self, token: str, base_url: str = "https://tapi.bale.ai/bot",
                 OTP_username: str, OTP_password: str, OTP_base_url: str = "https://safir.bale.ai"
        ...
        self.OTPclient_id = OTP_username
        self.OTPclient_secret = OTP_password
        self.OTPbase_url = OTP_base_url.rstrip("/")
        self.OTPtoken = None
        self.OTRtoken_expiry = None
